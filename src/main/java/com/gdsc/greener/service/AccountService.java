...
public class AccountService {
    ...
    public TokenDto login(UserRequest userRequest) {
        ...
        account.updateToken(jwtTokenProvider.createRefreshToken(account.getEmail(), account.getRole()));
    ...
    public TokenDto reissue(TokenRequest tokenRequest) {
        ...
        Account account = accountRepository.findByEmailAndStateAndToken(refreshId, UserStatus.NORMAL, tokenRequest.getRefreshToken())
